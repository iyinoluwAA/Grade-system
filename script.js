function submit(){
    ...
    if (scoreOfuser.value == "") {
        ...
        show.innerHTML = `F-fail your score is  <b class = "text-warning fs-3">${score}</b>😐🤐`
        songfail.play()   
       } 
        ...
        show.innerHTML = `D-credit your score is  <b class = "text-warning fs-3">${score}</b>🦦😑`
        songaverage.play() 
    }

        else if (score >=50 && score <60){
            show.innerHTML = `C-credit your score is  <b class = "text-warning fs-3">${score}</b>👀😑`
            songcredit.play()
        }
         
        else if (score >=60 && score < 70) {
            show.innerHTML = `B-Good your score is <b class = "text-warning fs-3">${score}</b> 😁👍`
            songgood.play()
        }
